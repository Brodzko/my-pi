...
export type QuerySessionDependencies = {
  ...
  serializeConversationForQuery: typeof serializeConversationForQuery;
...
export const createQuerySessionExecutor = (
  ...
  return async (
    ...
    try {
      ...
      const serialized = deps.serializeConversationForQuery(
        branchEntries.flat(),
        config.maxBytes
      );
